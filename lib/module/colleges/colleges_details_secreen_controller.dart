...
import '../../models/college_detail_model.dart';

class CollegeDetailController extends GetxController{
  late College  college;
  var isLoading=true.obs;
  var id='';
   Future <College>getCollegeInfoFromApi()async{
    var url;
    if(id!=null){
      url=Uri.parse(ServerConfig.domainNameServer +
          ServerConfig.collegieDetailNameServer+id);
    }
      ...
      if(response.body!=null) {
       ...
       // var result = jsonDecode(response.body);
        ...
        if(response.body.isNotEmpty) {
          ...
          return College.fromJson(jsonresponse);
        }
  ...
  void onReady()async {
    if(Get.arguments != null){
      ...
      print(id);
try{
  college=await getCollegeInfoFromApi() ;
