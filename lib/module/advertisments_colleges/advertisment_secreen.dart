...
import 'advertisment_controller.dart';
class AdvertismentCollegesSecreen extends StatelessWidget {
  AdvertismentController advertismentController=Get.put(AdvertismentController());
  @override
